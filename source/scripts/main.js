...
(function () {
    ...
    var playlist = function (spec) {
        var el = document.getElementById(spec.id),
            tracks = document.getElementById(spec.trackId),
            ...
            dropHandler = function (evt) {
                ...
                for (i = 0; i < length; i += 1) {
                    newMusic = document.createElement("li");
                    newMusic.textContent = files[i].name;
                    tracks.appendChild(newMusic);
                }
